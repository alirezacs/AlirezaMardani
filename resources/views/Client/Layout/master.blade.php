...
<head>
    ...
    <link href="{{ asset('assets/client/css/aos.css?ver=1.1.0') }}" rel="stylesheet">
    <link href="{{ asset('assets/client/css/bootstrap.min.css?ver=1.1.0') }}" rel="stylesheet">
    <link href="{{ asset('assets/client/css/main.css?ver=1.1.0') }}" rel="stylesheet">
    <noscript>
        <style type="text/css">
            [data-aos] {
                opacity: 1 !important;
...
<div class="page-content">
    <div>
                ...
                <div class="page-header page-header-small" filter-color="green">
                    ...
                    <div class="container">
                        <div class="content-center">
                            <div class="cc-profile-image"><a href="#"><img src="{{ asset('assets/client/images/anthony.jpg') }}" alt="Image"/></a></div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/project-1.jpg') }}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/project-2.jpg') }}" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/project-3.jpg') }}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#web-development">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/project-4.jpg') }}" alt="Image"/>
                                                <figcaption>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/graphic-design-1.jpg') }}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/graphic-design-2.jpg') }}" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/graphic-design-3.jpg') }}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#graphic-design">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/graphic-design-4.jpg') }}" alt="Image"/>
                                                <figcaption>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/photography-1.jpg') }}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/photography-3.jpg') }}" alt="Image"/>
                                                <figcaption>
                                ...
                                <div class="col-md-6">
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/photography-2.jpg') }}" alt="Image"/>
                                                <figcaption>
                                    ...
                                    <div class="cc-porfolio-image img-raised" data-aos="fade-up" data-aos-anchor-placement="top-bottom"><a href="#Photography">
                                            <figure class="cc-effect"><img src="{{ asset('assets/client/images/photography-4.jpg') }}" alt="Image"/>
                                                <figcaption>
                    ...
                    <div class="carousel slide" id="cc-Indicators" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 cc-reference-header"><img src="{{ asset('assets/client/images/reference-image-1.jpg') }}" alt="Image"/>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 cc-reference-header"><img src="{{ asset('assets/client/images/reference-image-2.jpg') }}" alt="Image"/>
                            ...
                            <div class="carousel-item">
                                <div class="row">
                                    <div class="col-lg-2 col-md-3 cc-reference-header"><img src="{{ asset('assets/client/images/reference-image-3.jpg') }}" alt="Image"/>
        ...
        <div class="section" id="contact">
            <div class="cc-contact-information" style="background-image: url('{{ asset('assets/client/images/staticmap.png') }}')">
                <div class="container">
...
<script src="{{ asset('assets/client/js/core/jquery.3.2.1.min.js?ver=1.1.0') }}"></script>
<script src="{{ asset('assets/client/js/core/popper.min.js?ver=1.1.0') }}"></script>
<script src="{{ asset('assets/client/js/core/bootstrap.min.js?ver=1.1.0') }}"></script>
<script src="{{ asset('assets/client/js/now-ui-kit.js?ver=1.1.0') }}"></script>
<script src="{{ asset('assets/client/js/aos.js?ver=1.1.0') }}"></script>
<script src="{{ asset('assets/client/scripts/main.js?ver=1.1.0') }}"></script>
</body>
</html>
