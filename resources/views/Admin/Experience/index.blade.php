    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        <div class="widget-content widget-content-area br-6">
            <div class="table-responsive mb-4 mt-4">
                <a href="{{ route('experience.create') }}" class="btn btn-sm btn-success">Create</a>
                <table id="experiences" class="table table-hover" style="width:100%">
                    <thead>
                    <tr>
                        <th>به عنوان</th>
                        <th>در</th>
                    ...
                    @foreach($experiences as  $experience)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('experience.edit', $experience->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('experience.destroy', $experience->id) }}" method="post" class="d-inline" enctype="multipart/form-data">
                                    @csrf
                                    @method('delete')
