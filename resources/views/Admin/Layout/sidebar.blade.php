...
<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <!-- Eduction -->
            <li class="menu">
                <a href="#eduction" data-active="{{ request()->is('admin/eduction*') ? 'true' : '' }}" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                    <div class="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
                        <span>تحصیلات</span>
                    </div>
                ...
                <ul class="collapse submenu list-unstyled {{ request()->is('admin/eduction*') ? 'show' : '' }}" id="eduction" data-parent="#eduction">
                    <li class="{{ request()->is('admin/eduction') ? 'active' : '' }}">
                        <a href="{{ route('eduction.index') }}">لیست</a>
                    </li>
                    <li class="{{ request()->is('admin/eduction/create') ? 'active' : '' }}">
                        <a href="{{ route('eduction.create') }}">ایجاد</a>
                    </li>
                </ul>
            </li>
            <!-- Eduction -->
